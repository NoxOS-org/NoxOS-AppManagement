...
readonly CASA_SERVICES=(
    "noxos-app-management.service"
)

readonly CASA_EXEC=noxos-app-management
readonly CASA_CONF=/etc/noxos/app-management.conf
readonly CASA_DB=/var/lib/noxos/db/app-management.db
