...
//go:generate bash -c "mkdir -p codegen/message_bus && go run github.com/deepmap/oapi-codegen/cmd/oapi-codegen@v1.12.4 -generate types,client -package message_bus ../NoxOS-MessageBus/api/message_bus/openapi.yaml > codegen/message_bus/api.go"
